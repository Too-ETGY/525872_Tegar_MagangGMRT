...
def three_dof(x, y, l1, l2, l3):
    gamma = 0  # Assuming end-effector orientation is 0 degrees (pointing forward)
    
    wrist_x = x - l3 * math.cos(gamma)
    wrist_y = y - l3 * math.sin(gamma)
...
def inverse_kinematics(x, y, z, l1, l2, l3):
    ...
    result = three_dof(r, z, l1, l2, l3)  # Adjust z by subtracting l0
    if result is None:
        return None
